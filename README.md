...
## Checklist
 ...
 - [X] Each Label has for and Id Attributes 
 - [X] ScreenReader active, reading input fields and page as needed 
 - [X] Focus goes to first error on submit 
 - [X] Text and highlights, error summaries all come into play to convey meaning 
 - [X] Tab changes focus to each input field 
 - [X] Does not store passwords in submitted data 
 - [X] local storage works well to keep saved draft to restored data 
 - [X] No console errors, and used console tools for debugging well 
 - [X] Phone normalisation with blur, worked as intended 

## ScreenShots

Landing Site, with empty input fields

![Landing Site](screenshots/landingSite.JPG)

Landing Site, with company toggle active

![Landing Site toggle](screenshots/landingSiteWithToggle.JPG)

Validation and Errors

![Error Validation](screenshots/errorValidation.JPG)

Saved Draft

![Saved Draft](screenshots/savedDraft.JPG)

Submitted Data Success

![Submit Success](screenshots/successfulSave.JPG)

Submitted Data excluding Password

![Data Saved](screenshots/submittedDataNoPassword.JPG)

Saved even on Refresh Restored Data

![Restored Data](screenshots/savedOnRefresh.JPG)

Created Breakpoint at saveDraft Function

![BreakPoint Created](screenshots/createdBreakpoint.JPG)

Pauses when entering field data, reaches the breakpoint

![Pause Website](screenshots/pausesWebsite.JPG)

Using Step over and Step Into Showcasing Scope data

![Step over and into](screenshots/stepInto.JPG)

Screen Reader Usage

![Screen Reader](screenshots/screenReader.JPG)